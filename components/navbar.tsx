...
export default function NavBar(): JSX.Element {
	return (
		<div className="flex p-4 gap-x-4 bg-red-400 rounded-b-4">
			...
			<div className={`
				rounded-lg bg-white border-b-2 border-solid border-b-red-600
				text-black w-full flex justify-center items-center p-4
			`}>
				<p className="text-5xl text-center">Pixelity</p>
			</div>
